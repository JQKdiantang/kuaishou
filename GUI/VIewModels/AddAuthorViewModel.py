...
from GUI.Utils import kuaishou, Util
from GUI.DataBase import SQLiteHelper
from GUI.VIews.ViewAddAuthor import Ui_AddAuthor
...
class AddAuthorVIewModel(QMainWindow, Ui_AddAuthor):
    ...
    def query(self):
        ...
        if gender == 'F':
            self.lbl_gender.setPixmap(QPixmap(":/png/female.png"))
        elif gender == 'M':
            self.lbl_gender.setPixmap(QPixmap(":/png/male.png"))
        else:
